  ...
  render() {
    ...
    return (
      <Result
        ...
        subTitle={"We have successfully configured your slide deck. You can find it in your Google Drive folder "+(this.props.folderName)+" or access it by clicking below:"}
        extra={[
